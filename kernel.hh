...
struct __attribute__((aligned(4096))) proc {
    ...
    template <typename T> void init_kernel(pid_t pid, void (T::* fx)());
...
template <typename T>
inline void proc::init_kernel(pid_t pid, void (T::* f)()) {
    static_assert(std::is_base_of<proc, T>::value, "T must derive from proc");
    void* avoid_warning = reinterpret_cast<void*>(f);
    init_kernel(pid, reinterpret_cast<void (*)(proc*)>(avoid_warning));
}
